...
/*
 * 6x8 ASCII bitmap font (5x7 glyph + 1 spacing column).
 * Derived from the classic Adafruit GFX public-domain 5x7 font.
 * Format: each glyph = 6 bytes, one per column, bit0 = top row.
 * Index = ASCII code - 0x20 (covers 0x20..0x7F, 96 glyphs).
 */
...
#define FONT6X8_COUNT   96

static const uint8_t font_6x8[FONT6X8_COUNT][FONT6X8_WIDTH] = {
    ...
    { 0x00, 0x08, 0x07, 0x03, 0x00, 0x00 }, /* 0x27 'apostrophe' */
